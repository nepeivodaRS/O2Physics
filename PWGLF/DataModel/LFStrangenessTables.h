...
DECLARE_SOA_TABLE(StraEvSelExtras, "AOD", "STRAEVSELEXTRAS",    //! debug information
                  ...
                  ft0::AmplitudeA, // Amplitudes of non-zero channels on the A-side. The channel IDs are given in ChannelA (at the same index)
                  ft0::AmplitudeC, // Amplitudes of non-zero channels on the C-side. The channel IDs are given in ChannelC (at the same index)
                  ft0::ChannelA, // Channel IDs on the A side which had non-zero amplitudes. There are at maximum 96 channels.
                  ft0::ChannelC, // Channel IDs on the C side which had non-zero amplitudes. There are at maximum 96 channels.
                  ft0::TimeA, // Average A-side time (ns)
                  ft0::TimeC, // Average C-side time (ns)
                  ft0::TriggerMask); // 8 trigger bits: OrA, OrC, Semi-central, Central, Vertex, IsActiveA, IsActiveC, IsFlangeEvent
